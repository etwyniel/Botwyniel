...
os.system('mv vendor/bin/* /app/.heroku/vendor/bin')
os.system('mv vendor/lib/* /app/.heroku/vendor/lib')
os.system('cp -r vendor/include/* /app/.heroku/vendor/include')
os.system('cp -r vendor/share/* /app/.heroku/vendor/share')
#os.system('rm -rf *')
"""
os.chdir('/app/.heroku')
